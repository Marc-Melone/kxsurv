...
> **Archive notice:** this is the original v1.0.0 implementation plan. Its code
> snippets and operational assumptions are historical and may conflict with
> v1.1.0, including explicit parameter registration and run-scoped alerts. It
> is not current operating documentation; see `README.md`,
> `SURVEILLANCE_FRAMEWORK.md`, and `SURVEILLANCE_PLAN.md` instead.
